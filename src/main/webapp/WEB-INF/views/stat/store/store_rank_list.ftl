<div style="color: #0099CC;background-color: #F3FBFE;clear: both;padding: 15px;border: solid 1px #DEEFFB">
    <span style="font-size: 12px;margin-right: 50px;white-space: nowrap">总下单量:<strong>${totalOrder}</strong></span>
    <span style="font-size: 12px;margin-right: 50px;white-space: nowrap">总销售额:<strong>${totalAmount}元</strong></span>
</div>
