...
<div class="page">
    ...
    <form method="post" name="formSearch" action="${base}/trade/evalGoods/list">
...
<form id="submit_form" action="${base}/trade/evalGoods/delete" method="post">
...
<script type="text/javascript">
	...
	function ajaxFileUploads(myBlogImage){
	    $.ajaxFileUpload({
	        ...
	        url: '${base}/trade/evalGoods/fileexcelUpload',
