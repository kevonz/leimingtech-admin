...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base">
                <li>
					<a  href="${base}/shopPointsOrder/shipments?orderState=30" <#if orderState==30 >class="current"</#if>>等待发货的订单</a>
				</li>
				<li>
					<a  href="${base}/shopPointsOrder/shipments?orderState=40" <#if orderState==40 >class="current"</#if>>发货中的订单</a>
				</li>
				<li>
					<a  href="${base}/shopPointsOrder/shipments?orderState=50" <#if orderState==50 >class="current"</#if>>已收到货的订单</a>
				</li>
            </ul>
        </div>
    </div>
    ...
    <form method="post" action="${base}/shopPointsOrder/shipments" name="formSearch" id="formSearch">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr>
                ...
                <td><input class="txt2" type="text" name="orderSn" value="${shopPointsOrder.pointOrdersn}" /></td>
            </tr>
            <tr>
			                					...
			                					<dl>
			            							...
			            							<dd class="vm">
			            								${order.pointBuyername} 
			          									...
			          									<#assign orderAddress = pointsOrderAddressTag('{"orderid":"${order.id }"}')/>
			          									<#if orderAddress??>
				          									<dl>
				            									<dt>收货信息：</dt>
				            									<dd class="ts">
