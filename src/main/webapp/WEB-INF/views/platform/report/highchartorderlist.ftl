					...
					<td>
						<#if item.orderState!=null>
						    <#if item.orderState==0>
						                      已取消
						     <#elseif (item.orderState==10)>
		                  		 待付款
		                     <#elseif (item.orderState==20)>
		               			   待发货
		                     <#elseif (item.orderState==30)>
		                 		  待收货
		                     <#elseif (item.orderState==40)>
		              			     交易完成
		                     <#elseif (item.orderState==50)>
		                		   已提交
		                     <#elseif (item.orderState==60)>
		                  		 已确认
						    </#if>
						</#if>
					</td>
