...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>村博士代购-会员中心</title>
		<base href="" />
		<link rel=stylesheet type=text/css href="${base}/res/union/jd/css/user_index_2260954297.css" />
		<script type="text/javascript" src="${base}/res/union/jd/js/user_index_960609130.js"></script>
		<style type="text/css">
			...
			.nr img{ width:300px;}
			.tuichu{background:#f9f9f9; width:100%; padding:15px 0 ; margin-top:15px;font-size:16px; text-align:center; color:#999}
			.tuichu a{text-align:center; color:#000}
		</style>
	</head>
	<body>
		<div class="yingdao" align="center" style="background:#EC1A5B;">
  			<p>
	  			...
	  			<#--><a href='http://www.cunboshi.net/m/index.php?mod=tao&act=tao' title="搜索" class="right"></a>--> 
  			</p>
		</div>  
    	...
    	<div class="user">
      		<div class="vipuser">
              	<div class="vipuserleft2"><img src="${base}/res/union/jd/images/noavatar_middle.jpg" width="50" height="50" border="0"/></div> 
		   		<div class="vipusercenter">
		   			<div class="wz1">12345678901 </div>
	   			</div>				  
   			</div>
  		</div>              
		<!-- <div class="adminmenu">
   <ul>
	<li style="height:50px; padding-top:11px"><div class="adminmenu_wdfl"></div><div class="adminmenu_a">我的余额 ：<span class="money font1">0.00元</span> </div><div class="nva"></div></li>
		</ul>
	</div>-->
	 	<div class="adminmenu" style="margin-bottom:0px">
   			<ul>
				<li style="height:50px; padding-top:11px">
					<div class="adminmenu_wdjfb"></div>
					<div class="adminmenu_a">我的集分宝：<span class="jifenbao font1">0个</span></div>
					<div class="nva"></div>
				</li>
			</ul>
		</div>
	
        <div class="adminmenu" style="border-top:1px #E7E7E7 solid; margin-top:15px">
   			<ul>
				<a id="index" href="javascript:void(0);">
					<li>
						<div class="adminmenu_wddd"></div>
						<div class="adminmenu_a">我的订单</div>
						<div class="nva"></div>
					</li>
				</a>
			</ul>
	  	...
	  	<div class="adminmenu">
			<ul>
				<a id="index" href="javascript:void(0);">
					<li>
						<div class="adminmenu_wdzh"></div>
						<div class="adminmenu_a">账户设置</div>
						<div class="nva"></div>
					</li>
				</a>
			</ul>
	  	...
	  	<div class="adminmenu">
   			<ul>
				<a id="index" href="javascript:void(0);">
					<li>
						<div class="adminmenu_jlcx"></div>
						<div class="adminmenu_a">修改密码</div>
						<div class="nva"></div>
					</li>
				</a>
			</ul>
		...
		<div class="adminmenu">
   			<ul>
				<a id="index" href="javascript:void(0);">
					<li>
						<div class="adminmenu_jlcx"></div>
						<div class="adminmenu_a">我的二维码</div>
						<div class="nva"></div>
					</li>
				</a>
			</ul>
	  	...
	  	<div class="adminmenu">
   			<ul>
				<a href="javascript:void(0);" >
					<li>
						<div class="adminmenu_bzzx"></div>
						<div class="adminmenu_a">帮助中心</div>
						<div class="nva"></div>
					</li>
				</a>
			</ul>
