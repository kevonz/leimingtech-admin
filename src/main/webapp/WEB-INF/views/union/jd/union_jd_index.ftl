				...
				<table width="100%" border="0">
	            	<tr> 
	            		<td width="100" rowspan="2"> <img src="${base}/res/union/jd/images/07431232044.png" class="logo" border="0" width="124" height="50"/></td>
	 					<td> <span class="wzwz"> Hi，村博士代购欢迎您！</span></td> 
					</tr>
	               	<tr> 
	               		<td>
	               			<span class="wzwz2"> 
	               				<#--
	               				<a href="http://www.cunboshi.net/m/index.php?mod=user&act=register" >免费注册</a>
	               				<a href="http://www.cunboshi.net/m/index.php?mod=user&act=login" >账号登录</a>
	               				-->
               				</span>
       				</td>
				    </tr>
	      		...
	      		<div class="gonggao" id="user_notice">
	          		<ul>
	            		<li>
	                		...
	                		<a style="text-decoration:none; font-size:12px" href="/m/index.php?mod=article&act=view&id=43" >村博士京东精选上线啦！</a> 
	            		</li>
	            	</ul>
	    		</div> 
		...
		<div align="center">
			...
			<div class="zhutu" style="height:100px">
				...
				<a href="${base}/unionJD/list?type=rx"><span class="span1 span15"></span><span class="span2">热销商品</span></a>
			          <!--<a href="http://www.cunboshi.com:8088/dg/dg.apk"><span class="span1 span14"></span><span class="span2">手机版</span></a>-->
	        </div>  
