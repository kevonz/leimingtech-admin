...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="goodsBody">
			...
			<p class="buy"> 
	     		<a href="<#if errorCode?exists && errorCode=='subUnionId_is_null'>javascript:alert('村长，您太着急了，都忘记登录啦！');<#elseif errorCode?exists && errorCode=='token_invalid'>javascript:alert('现在暂时不能提供购买，快点联系平台管理员重新授权');<#else>${jdUrl!''}</#if>" target="_blank"class="left">去网站购买</a>
