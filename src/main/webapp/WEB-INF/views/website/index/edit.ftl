...
<form id="store_class_form" name="floorForm" method="post" action="${base}/website/index/save">
    <table class="table tb-type2">
        ...
        <input type="hidden" name="gcId" id="gcId" value="${vo.gcId}">
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                ...
                <#list vo.goodsClassList as gc>
                    <input type="hidden" name="goodsClassList[${gc_index}].gcId" value="${gc.gcId}"/>
                    <input type="text" name="goodsClassList[${gc_index}].gcName" value="${gc.gcName}" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px"/>
                </#list>
                </div>
            </td>
        ...
        <tr class="noborder">
        	<input type="hidden" name="floorImg" id="floorImg" value="${vo.floorImg}"/>
        	<input type="hidden" name="floorUrl"  id="floorUrl" value="${vo.floorUrl}"/>
            <td class="vatop rowform">
            	<#if vo.floorImg??>
                	<img id="floorThemeImg" width="212px" src="${imgServer}${vo.floorImg}"/>
                <#else>
        ...
        <tr class="noborder">
        	<input type="hidden" name="bannerImg" id="bannerImg" value="${vo.bannerImg}"/>
        	<input type="hidden" name="bannerUrl" id="bannerUrl" value="${vo.bannerUrl}"/>
            <td class="vatop rowform">
	            <#if vo.bannerImg??>
	            	<img id="floorBannerImg" width="210px" src="${imgServer}${vo.bannerImg }"/>
	            <#else>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="text"  class="txt" name="floorName" id="floorName" value="${vo.floorName}"></td>
            <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="text"  class="txt" name="subName" id="subName" value="${vo.subName}"></td>
            <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform">
                ...
                <div id="floorGoodsData">
	                <#list vo.goodsList as goods>
                          <input type='hidden' name='goodsList[${goods_index}].goodsId' value='${goods.goodsId}'/>
                          <input type='hidden' name='goodsList[${goods_index}].goodsName' value='${goods.goodsName}'/>
                          <input type='hidden' name='goodsList[${goods_index}].goodsMarketprice' value='${goods.goodsMarketprice}'/>
                          <input type='hidden' name='goodsList[${goods_index}].goodsPrice' value='${goods.goodsPrice}'/>
                          <input type='hidden' name='goodsList[${goods_index}].goodsImage' value='${goods.goodsImage}'/>
                     </#list>
                </div>
            </td>
            <td class="vatop tips"></td>
        ...
        <tr class="noborder">
             	<td>
	             	<select name="floorColor">
		             		<option value="pink" <#if (vo.floorColor='pink')>selected</#if>>粉色</option>
		             		<option value="blue" <#if (vo.floorColor='blue')>selected</#if>>蓝色</option>
		             		<option value="orange" <#if (vo.floorColor='orange')>selected</#if>>橙色</option>
		             		<option value="red" <#if (vo.floorColor='red')>selected</#if>>红色</option>
		             		<option value="brown" <#if (vo.floorColor='brown')>selected</#if>>棕色</option>
		             		<option value="green" <#if (vo.floorColor='green')>selected</#if>>绿色</option>
		             		<option value="purple" <#if (vo.floorColor='purple')>selected</#if>>紫色</option>
		             		<option value="gray" <#if (vo.floorColor='gray')>selected</#if>>浅色</option>
		             	</select>
             	</td>
             	<td class="vatop tips"> </td>
         </tr>
        ...
        <tr class="noborder">
             <td class="vatop rowform onoff"><label for="isShow1" class="cb-enable <#if vo.isShow == 1>selected</#if>"><span>是</span></label>
                 <label for="isShow0" class="cb-disable <#if vo.isShow == 0>selected</#if>"><span>否</span></label>
                 <input id="isShow1" name="isShow"  value="1" type="radio" <#if vo.isShow == 1>checked="true" </#if>>
                 <input id="isShow0" name="isShow" value="0" type="radio" <#if vo.isShow == 0>checked="true" </#if>></td>
             </td>
             <td class="vatop tips"></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
            <td class="vatop rowform"><input type="text" name="sort" class="txt" value="${vo.sort}">
                </td>
    ...
    <div class="dialog-show-box">
        ...
        <table class="tb-type1 noborder search">
            ...
            <tr>
                ...
                <td><input type="text" value="${goodsName}" name="recommend_goods_name" id="recommend_goods_name" class="txt">
