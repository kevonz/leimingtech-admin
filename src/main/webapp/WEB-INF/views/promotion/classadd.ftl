	 ...
	 <div class="fixed-empty"></div>
		...
		<table class="table tb-type2 nobdb">
		    <tbody>
		        ...
		        <tr class="noborder">
		          <td class="vatop rowform"><input type="text" name="pcSort" class="txt" value="${promotionClass.pcSort}"></td>
		        </tr>
		      <tr class="noborder">
		        ...
		        <tr class="noborder">
		          <td class="vatop rowform">
		          	<input type="text" name="startStr" value="${promotionClass.startTimeStr?string("yyyy-MM-dd HH:mm:ss")}" class="txt Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss.ss'});">
		          </td>
		        </tr>
		        <tr class="noborder">
		        ...
		        <tr class="noborder">
		          <td class="vatop rowform"><input type="text" name="endStr" value="${promotionClass.endTimeStr?string("yyyy-MM-dd HH:mm:ss")}" class="txt Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss.ss'});">
		          </td>
		        </tr>
		        <tr class="noborder">
		        ...
		        <tr class="noborder">
		          <td class="vatop rowform">启用：<input id="pcStatus" type="radio" name="pcStatus" value="0" <#if (promotionClass.pcStatus!=1)>checked</#if> />
		          停用：<input type="radio" id="pcStatus" name="pcStatus" value="1" <#if (promotionClass.pcStatus=1)>checked</#if>/></td>
		        </tr>
		       	<tr>
