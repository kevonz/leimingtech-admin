    ...
    <form id="post_form" method="post" name="form1" action="${base}/setting/payment/saveOrUpdate">
        <table class="table tb-type2 nobdb">
            ...
            <tr>
             ...
             <tr>
                <td colspan="2" class="required">支付编码： 取汉字的首字母如支付宝（ZFB）:</td>
            </tr>
            <tr>
                  <td>
            ...
            <tr class="noborder">
                <td class="vatop rowform onoff"><label for="payment_state1" class="cb-enable" ><span>是</span></label>
                  ...
                  <td>
                        <div class="logo clf" > 
                              <a href="javascript:void(0);" class="btn-upload btng-s" style="background-color:#eee; color:#000; cursor:pointer;float: left;">
                                 ...
                                 <br><br>  <p><img  src="${base}/images/nopic.png" width="100px" height="100px" id="paymentLogoimg" class="img" style="float: left;"></p>
			            </div>
			            <input type="hidden" id="paymentLogo"  name="paymentLogo" value="${dbpayment.paymentLogo}" />
                 </td>
                <td class="vatop tips">支持 格式gif,jpg,jpeg,png</td>
            </tr>
            </tbody>
            <tfoot>
            <tr class="tfoot">
