...
<div class="page">
    ...
    <form id="spec_form" method="post" action="javascript:void(0);">
        <table class="table tb-type2">
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="spName" id="s_name" value="${goodsSpec.spName}" /></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform"><input type="text" class="txt" name="spSort" id="s_sort" value="${goodsSpec.spSort}" /></td>
            ...
            <tr class="noborder">
                <td class="vatop rowform">
                	...
                	<#else>
                		<input type="radio" name="spFormat" specType="wenzi"/>文字
	                	<input type="radio" name="spFormat" checked="checked" specType="tupian"  value="1"/>图片
                	</#if>
				</td>
		            ...
		            <tr class="noborder" name="specValueDiv">
		                <td class="vatop rowform" colspan="1.5">
		                	...
		                	<p href="javascript:void(0);" style="display: none;" name="spValueImage">
								...
								<input type="hidden" value="${sv.spValueImage}"/>
							</p>
		                </td>
						<td class="vatop rowform">
