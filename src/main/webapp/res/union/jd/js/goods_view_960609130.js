...
/*m/template/vipduo/inc/js/jquery.js*/
...
/*m/template/vipduo/inc/js/iscroll.js*/
// JavaScript Document
function sousuo(){
	var v=$('#keywords').val()
	if(v==''){
...
function checkForm($this,cb){
	...
	var word='';
	var status=true;
	var ddPatternArr={'int':/^[0-9]+$/,'num':/^[0-9]+(.[0-9]{2})?$/,'float':/^[0-9]+\.?[0-9]+$/,'mobile':/^1\d{10}$/,'alipay':'mobile'};
//'email':/^[-_A-Za-z0-9\.]+@([_A-Za-z0-9]+\.)+[A-Za-z0-9]{2,3}$/, 'alipay':'email|mobile'
	var input={};
	var $form=$this;
	...
	$this.find('input').each(function(){
		if(status==false){ //return false涓嶈兘閫€鍑哄惊鐜紝鎵€浠ュ鍔犱簡杩欎釜鍒ゆ柇锛堝彲鑳芥槸jqmobi涓嶈鍚э紝jquery娌℃祴璇曪級
			return false;
		}
...
function setCookie(name, value,expiredays) {
	...
	var exp = new Date();
	exp.setTime(exp.getTime() + expiredays); //3澶╄繃鏈�
...
/*m/template/vipduo/inc/js/fun.js*/
...
/*m/template/vipduo/inc/js/base64.js*/
/*
...
(function($, window, document, undefined) {
    ...
    $.fn.lazyload = function(options) {
        ...
        this.each(function() {
            var self = this;
            var $self = $(self);
			if(typeof PICJM!='undefined' && PICJM==1){
...
/*m/template/vipduo/inc/js/jquery.lazyload.js*/