...
(function($) {
	$.fn.KinSlideshow = function(settings) {
		...
		var btn_Bak = {
			btn_bgColor: "#f1f1f1",
			btn_bgHoverColor: "#FF6699",
			btn_fontColor: "#f1f1f1",
			btn_fontHoverColor: "#f1f1f1",
			btn_fontFamily: "Verdana",
			btn_borderColor: "#f1f1f1",
			btn_borderHoverColor: "#FF6699",
			btn_borderWidth: 1,
			btn_bgAlpha: 0.7
		}
		...
		function KSS_setBtn() {
			...
			if (settings.isHasBtn && KSS_imgaeLength >= 2) {
				$(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:8px;bottom:5px; z-index:100'></div>");
				var KSS_btnList = "";
