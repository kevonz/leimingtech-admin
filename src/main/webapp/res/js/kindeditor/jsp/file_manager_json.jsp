...
Map<String,Object> maps = Maps.newHashMap();
    maps.put("moveup_dir_path", moveupDirPath);
    maps.put("current_dir_path", currentDirPath);
    maps.put("current_url", currentUrl);
    maps.put("total_count", fileList.size());
    maps.put("file_list", fileList);
